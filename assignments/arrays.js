...
// .length is a METHOD that evaluates the total number of items in the index of the array it is called upon
// the variable of i is a BANANA word....just like in algebra it is just a random variable name...semantic naming is helpful tho

for (let i = 0 ; i < inventory.length ; i++) {
    // do something each time the conditions in the arguements are met
    // console.log(`Found this car ${inventory[i].car_model}`)
    // .push() is an array method that will allow you to place items inside of a MUTABLE array! Takes an arguement of what you want to put in the array at the next available position....
